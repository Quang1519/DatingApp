...
namespace API.SignalR
{
    ...
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            var sender = await _uow.UserRespository.GetUserByUsernameAsync(username);
            var recipient = await _uow.UserRespository.GetUserByUsernameAsync(createMessageDto.RecipientUsername);
